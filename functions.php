...
function bones_ahoy() {
  ...
  require_once( 'library/all-custom-post-types.php' );
...
add_image_size( 'sidebar_image', 832, 1100, false );
...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        ...
        'portfolio_gallery_thumbnail' => __('Gallery Thumbnail'),
    ) );
}
...
/************* ADD ADDITIONAL STYLES TO EDITOR ******************/
